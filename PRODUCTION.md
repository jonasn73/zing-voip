...
| `TELNYX_MESSAGING_FROM_E164` | Optional override for **outbound SMS** sender (E.164). If unset, lyncr uses the workspace’s first **Telnyx-purchased** active line and auto-assigns it to the **Lyncr SMS** messaging profile. |
